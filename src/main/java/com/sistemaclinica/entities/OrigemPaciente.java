...
/**
 * OrigemPaciente generated by hbm2java
 */
@Entity
@Table(name="ORIGEM_PACIENTE"
    ,schema="DESENV"
)
public class OrigemPaciente  implements java.io.Serializable {


     private OrigemPacienteId id;
    ...
    public OrigemPaciente() {
    }

	
    public OrigemPaciente(OrigemPacienteId id, Empresa empresa, String nome, String ativo) {
        this.id = id;
        this.empresa = empresa;
        this.nome = nome;
        this.ativo = ativo;
    }
    public OrigemPaciente(OrigemPacienteId id, Empresa empresa, String nome, String ativo, BigDecimal cdCriadoPor, Date dtCriacao, BigDecimal cdAlteradoPor, Date dtUltimaAlteracao, Set pacientes) {
       this.id = id;
       this.empresa = empresa;
       this.nome = nome;
       this.ativo = ativo;
    ...
    public OrigemPacienteId getId() {
        return this.id;
    }
    
    public void setId(OrigemPacienteId id) {
        this.id = id;
    }
...
@OneToMany(fetch=FetchType.LAZY, mappedBy="origemPaciente")
