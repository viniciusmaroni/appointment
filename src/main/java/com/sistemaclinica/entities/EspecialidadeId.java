...
/**
 * EspecialidadeId generated by hbm2java
 */
@Embeddable
public class EspecialidadeId  implements java.io.Serializable {
    ...
    public EspecialidadeId(BigDecimal id, BigDecimal empId) {
       this.id = id;
       this.empId = empId;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof EspecialidadeId) ) return false;
		 EspecialidadeId castOther = ( EspecialidadeId ) other; 
